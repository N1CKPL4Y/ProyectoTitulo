                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="basic-addon1">R.U.T</span>
                                                    </div>
                                                    ...
                                                    <div class="row justify-content-around">
                                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                                            <a role="button" target="_blank" href="../controller/controllerBitacoraPDF.php?id=<?php echo $value['id']; ?>">
                                                                <i class='bx bxs-file-pdf'></i>Bitácora de Atención N° <?php echo $cont . " Codigo: " . $value['beneficiario']; ?> - Programa <?php echo $value['programa']; ?> - Fecha: <?php echo $fechaB; ?> / Hora: <?php echo $value['hora']; ?>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <?php
