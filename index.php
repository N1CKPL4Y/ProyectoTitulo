...
<html>
    ...
    <body>
        ...
        <div class="ui bottom attached segment pushable">
            <div class="ui inverted labeled icon left inline vertical sidebar menu uncover animating" style="">
                <a class="item">
                    <i class="home icon"></i>
                    Home
                </a>
        ...
        <button class="ui primary test button">
            Save
        </button>
